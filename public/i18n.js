// Kratuxil i18n System - Auto language detection & switching
class I18n {
  constructor() {
    this.currentLang = 'en';
    this.translations = {};
  ...
  async init() {
    const savedLang = localStorage.getItem('Kratuxil_language');
  ...
  applyTranslations() {
    ...
    const brandHref = brandLink ? brandLink.href : 'https://Kratuxil-official.org';
  ...
  async switchLanguage(lang) {
    ...
    localStorage.setItem('Kratuxil_language', lang);
